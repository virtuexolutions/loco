...
<script>
  ...
  // $('.add-option-properites').click(function() {
  //   debugger
  //     $('.properties_records').clone().appendTo('.properties_records_dynamic');
  //     $('.properties_records_dynamic .properties_records').addClass('single remove');
  //     $('.single .add-option-properites').remove();
  //     $('.single').append('<a href="#" class="remove-field btn-remove-properties  btn btn-danger btn-sm">Remove properties</a>');
  //     $('.properties_records_dynamic > .single').attr("class", "remove");
      
  //     $('.properties_records_dynamic input').each(function() {
  //         var count = 0;
